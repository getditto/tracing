...
//!
//! ```
//! use tracing_subscriber::{fmt, fmt::FmtTarget};
//!
...
//!
//! ```rust
//! use tracing_subscriber::{fmt, fmt::FmtTarget, EnvFilter};
...
#[doc(inline)]
pub use self::{
    format::{format, FmtTarget, FormatEvent, FormatFields},
    time::time,
