...
fn test_message_ansi_escaping() {
    ...
    tracing::subscriber::with_default(subscriber, || {
        ...
        tracing::info_internal!("User input: {}", malicious_input);
    });
...
fn test_json_ansi_escaping() {
    ...
    tracing::subscriber::with_default(subscriber, || {
        ...
        tracing::info_internal!("Testing: {}", malicious_input);
        tracing::info_internal!(user_input = %malicious_input, "Field test");
    });
...
fn ansi_sanitization_prevents_injection() {
    ...
    tracing::subscriber::with_default(subscriber, || {
        ...
        tracing::error_internal!(malicious_field = malicious_field_value, "Field test");
        ...
        tracing::error_internal!("{}", malicious_error);
    });
...
fn test_c1_control_characters_escaping() {
    ...
    tracing::subscriber::with_default(subscriber, || {
        ...
        tracing::info_internal!("C1 controls: {}", c1_controls);
    });
