...
#[tracing::instrument]
fn simulate_logging() {
    tracing::info_internal!("This is an info message");
    tracing::error_internal!("This is an error message");
    tracing::warn_internal!("This is a warning message");
    tracing::debug_internal!("This is a debug message");
    tracing::trace_internal!("This is a trace message");
...
fn with_fields(foo: u32, bar: &'static str) {
    tracing::info_internal!(foo, bar, "This is an info message with fields");
}

#[tracing::instrument(level = "trace")]
fn trace_span() {
    tracing::error_internal!("Error message inside a span with trace level");
    tracing::info_internal!("Info message inside a span with trace level");
    tracing::trace_internal!("Trace message inside a span with trace level");
}

#[tracing::instrument]
fn debug_span() {
    tracing::error_internal!("Error message inside a span with debug level");
    tracing::info_internal!("Info message inside a span with debug level");
    tracing::debug_internal!("Debug message inside a span with debug level");
}

#[tracing::instrument]
fn info_span() {
    tracing::error_internal!("Error message inside a span with info level");
    tracing::info_internal!("Info message inside a span with info level");
    tracing::debug_internal!("Debug message inside a span with info level");
}

#[tracing::instrument]
fn warn_span() {
    tracing::error_internal!("Error message inside a span with warn level");
    tracing::info_internal!("Info message inside a span with warn level");
    tracing::debug_internal!("Debug message inside a span with warn level");
}

#[tracing::instrument]
fn error_span() {
    tracing::error_internal!("Error message inside a span with error level");
    tracing::info_internal!("Info message inside a span with error level");
    tracing::debug_internal!("Debug message inside a span with error level");
}

#[tracing::instrument(target = "other_crate")]
fn other_crate_span() {
    tracing::error_internal!(target: "other_crate", "An error message from another crate");
    tracing::warn_internal!(target: "other_crate", "A warning message from another crate");
    tracing::info_internal!(target: "other_crate", "An info message from another crate");
    tracing::debug_internal!(target: "other_crate", "A debug message from another crate");
    tracing::trace_internal!(target: "other_crate", "A trace message from another crate");
}
