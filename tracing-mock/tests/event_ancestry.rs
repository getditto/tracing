...
fn contextual_parent() {
    ...
    with_default(subscriber, || {
        let _guard = tracing::info_span_internal!("contextual parent").entered();
        tracing::info_internal!(field = &"value");
    });
...
fn contextual_parent_wrong_name() {
    ...
    with_default(subscriber, || {
        let _guard = tracing::info_span_internal!("another parent").entered();
        tracing::info_internal!(field = &"value");
    });
...
fn contextual_parent_wrong_id() {
    ...
    with_default(subscriber, || {
        let _span = tracing::info_span_internal!("contextual parent");
        let _guard = tracing::info_span_internal!("another parent").entered();
        tracing::info_internal!(field = &"value");
    });
...
fn contextual_parent_wrong_level() {
    ...
    with_default(subscriber, || {
        let _guard = tracing::debug_span_internal!("contextual parent").entered();
        tracing::info_internal!(field = &"value");
    });
...
fn expect_contextual_parent_actual_explicit_parent() {
    ...
    with_default(subscriber, || {
        let span = tracing::info_span_internal!("explicit parent");
        tracing::info_internal!(parent: span.id(), field = &"value");
    });
...
fn expect_contextual_parent_actual_explicit_root() {
    ...
    with_default(subscriber, || {
        let _guard = tracing::info_span_internal!("contextual parent").entered();
        tracing::info_internal!(parent: None, field = &"value");
    });
...
fn explicit_parent_wrong_name() {
    ...
    with_default(subscriber, || {
        let span = tracing::info_span_internal!("another parent");
        tracing::info_internal!(parent: span.id(), field = &"value");
    });
...
fn explicit_parent_wrong_id() {
    ...
    with_default(subscriber, || {
        let _span = tracing::info_span_internal!("explicit parent");
        let another_span = tracing::info_span_internal!("another parent");
        tracing::info_internal!(parent: another_span.id(), field = &"value");
    });
...
fn explicit_parent_wrong_level() {
    ...
    with_default(subscriber, || {
        let span = tracing::debug_span_internal!("explicit parent");
        tracing::info_internal!(parent: span.id(), field = &"value");
    });
